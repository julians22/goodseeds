...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .article-detail-content p span.melinda{
...
<main class="py-5" style="background:#f1f2f2;">
        ...
        <div class="row">
            <div class="col-md-12">
                <div data-aos="fade-up" data-aos-duration="900" data-aos-easing="ease-in-out" class="article-detail-content">
                    @php
                        $rawContent = $success->getTranslation('content', app()->getLocale());
    ...
    <div class="container article-detail">
        <div class="row">
            <div class="col-md-12">
                <div class="article-detail-content" data-aos="fade-up" data-aos-duration="900" data-aos-easing="ease-in-out" style="overflow-x:auto;">
                    {!! $content_en !!}
                </div>
            </div>
        </div>
    ...
    <div class="container">
        @if ($previous || $next)
            <div class="d-flex justify-content-between mt-5" data-aos="fade-down" data-aos-duration="900" data-aos-easing="ease-in-out">
                @if ($previous)
                    <a href="{{ route('success-story-detail', $previous->localized_slug) }}" 
                       class="btn-nav">
                ...
                @if ($next)
                    <a href="{{ route('success-story-detail', $next->localized_slug) }}" 
                       class="btn-nav">
